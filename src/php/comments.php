		...
		<div class="offset3 span9">
			...
			<?php if ( have_comments() ) : ?>
				...
				<nav id="comment-nav-below" class="navigation" role="navigation">
					<?php previous_comments_link( __( '<div class="nav-previous btn pull-left">&larr; &Auml;ltere Kommentare</div>', 'sgb' ) ); ?>
					<?php next_comments_link( __( '<div class="nav-next btn pull-right">Neuere Kommentare &rarr;</div>', 'sgb' ) ); ?>
				</nav>
			...
			?>
				<div class="well">
					<p class="comments">
						<?php _e( 'Diese Seite wurde noch nicht kommentiert!', 'sgb' ); ?>
						<a href="#comment-form" class="btn pull-right"><i class="icon-edit"></i> Einen Beitrag verfassen</a>
					</p>
				</div>
			<?php // If comments are closed and there are comments, let's leave a little note.
				elseif ( ! comments_open() && '0' != get_comments_number() && post_type_supports( get_post_type(), 'comments' ) ) :
